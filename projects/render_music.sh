...
gen "$PROJ/hank_and_doug/wild_rescue" wild_rescue \
  ...
  "instrumental, no vocals, no singing, cinematic orchestral adventure, Pixar soundtrack, 3 minutes 30 seconds"
gen "$PROJ/leash_snapped" leash_snapped \
  ...
  "instrumental, no vocals, no singing, funk pop comedy score, upbeat, 3 minutes 30 seconds"
gen "$PROJ/red_rock_standoff" red_rock \
  ...
  "instrumental, no vocals, no singing, vintage 1960s western soundtrack, Ennio Morricone style, 3 minutes"
gen "$PROJ/red_horizon" red_horizon \
  ...
  "instrumental, no vocals, no singing, cinematic sci-fi ambient score, 3 minutes"
gen "$PROJ/last_treasure" last_treasure \
  ...
  "instrumental, no vocals, no singing, pirate adventure film score, orchestral, 3 minutes"
echo MUSIC_ALL_DONE
